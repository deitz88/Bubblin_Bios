...
@__DSOCacheEntry_name.54 = internal constant [27 x i8] c"libaot-Bubblin_Bios.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [476 x %struct.DSOCacheEntry] [
	...
	; 87
	%struct.DSOCacheEntry {
		i64 852090528, ; hash 0x32c9dea0, from name: libaot-Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 88
	%struct.DSOCacheEntry {
	...
	; 99
	%struct.DSOCacheEntry {
		i64 956214229, ; hash 0x38feabd5, from name: libaot-Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 120
	%struct.DSOCacheEntry {
		i64 1125550575, ; hash 0x431689ef, from name: aot-Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 206
	%struct.DSOCacheEntry {
		i64 1924548766, ; hash 0x72b6489e, from name: aot-Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 218
	%struct.DSOCacheEntry {
		i64 1988873966, ; hash 0x768bceee, from name: Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 395
	%struct.DSOCacheEntry {
		i64 3484496991, ; hash 0xcfb1345f, from name: Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.54, i32 0, i32 0), ; name
		i8* null; handle
	}, 
