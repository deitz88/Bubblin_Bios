...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"30c17cfe-a2ab-46c2-8e75-f418e4008db4\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [29 x i8] c"com.companyname.bubblin_bios\00", align 16
...
@__DSOCacheEntry_name.31 = internal constant [36 x i8] c"libaot-CommunityToolkit.Mvvm.dll.so\00", align 16
...
@__DSOCacheEntry_name.61 = internal constant [27 x i8] c"libaot-Bubblin_Bios.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [476 x %struct.DSOCacheEntry] [
	...
	; 111
	%struct.DSOCacheEntry {
		i64 4704849459549114789, ; hash 0x414afba7f61d11a5, from name: aot-Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 112
	%struct.DSOCacheEntry {
	...
	; 203
	%struct.DSOCacheEntry {
		i64 8599071512876648524, ; hash 0x775609fb2b31884c, from name: Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 262
	%struct.DSOCacheEntry {
		i64 10471219524517094060, ; hash 0x91513eadbbf9e2ac, from name: Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 329
	%struct.DSOCacheEntry {
		i64 12972017315678394933, ; hash 0xb405dd05193a1a35, from name: libaot-Bubblin_Bios
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 387
	%struct.DSOCacheEntry {
		i64 14920234870007261482, ; hash 0xcf0f5290402de92a, from name: aot-Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 463
	%struct.DSOCacheEntry {
		i64 18105241331437349160, ; hash 0xfb42bd10b50b2928, from name: libaot-Bubblin_Bios.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.61, i32 0, i32 0), ; name
		i8* null; handle
	}, 
